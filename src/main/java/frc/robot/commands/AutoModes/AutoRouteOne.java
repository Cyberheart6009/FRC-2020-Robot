...
public class AutoRouteOne extends SequentialCommandGroup {
  ...
  public AutoRouteOne(ChassisSubsystem chassis_subsystem, ShooterSubsystem shooter_subsystem, IntakeSubsystem intake_subsystem) {
	...
	addCommands(
        ...
        new TurnInPlaceCommand(c_subsystem, 1, 30),
