...
public class AutoRouteThree extends SequentialCommandGroup {
  ...
  public AutoRouteThree(ChassisSubsystem chassis_subsystem, ShooterSubsystem shooter_subsystem, ShooterFeederSubsystem shooterFeederSubsystem,IntakeSubsystem intake_subsystem) {
	...
	addCommands(
        ...
        new TurnInPlaceCommand(c_subsystem, 0.85, -40), 
